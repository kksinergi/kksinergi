            ...
            <div className="block bg-[#0443AC]/70 w-full h-full">
              <div className="flex flex-col items-center justify-center w-full h-full py-8 px-4 sm:px-8 md:px-16 lg:px-32 xl:px-72 gap-4">
                ...
                <Link href="/team" className="flex items-center justify-center h-full">
                  <button className="flex px-4 py-2 sm:px-6 sm:py-4 bg-(--color-secondary) text-(--color-buttonSecondary) rounded-[20px] font-semibold cursor-pointer text-[16px] sm:text-[20px] text-center">Lihat Susunan Tim</button>
                </Link>
              </div>
            </div>
          </div>
