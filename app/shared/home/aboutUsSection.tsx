...
export default function AboutUsSection() {
  return (
    <section id="tentangkami" className=" font-[family-name:var(--font-geist-sans) overflow-hidden">
      <div className="flex flex-col px-8 py-32 h-full gap-20">
        ...
        <div className="flex flex-col xl:flex-row items-center justify-center w-full h-full gap-10">
          {aboutItems.map((item) => (
            <div key={item.title} className="w-full flex flex-col sm:flex-row sm:items-start items-center justify-center gap-4 bg-transparent p-6">
              ...
              <div className="flex flex-col w-full h-fit gap-2">
                <h3 className={`text-2xl text-center lg:text-left font-semibold text-(${item.color})`}>{item.title}</h3>
